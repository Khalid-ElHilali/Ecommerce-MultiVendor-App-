      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at support@Shopclick.com with your order number and a brief
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@Shopclick.com, or by calling us at (+212) 606060606
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                we are pleased to offer international shipping to our customers
                around the world. Our commitment is to ensure that no matter
                where you are located, you can enjoy the convenience and quality
                of our products. We strive to provide a seamless and efficient
                shipping experience, making it easier than ever to receive your
                orders promptly and reliably.
              </p>
            </div>
          )}
        </div>
